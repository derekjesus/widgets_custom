 ...
 * HomeConten4 class name to a custom name of your choice. Have fun! redrokk.com
 * 
 * Plugin Name: HomeConten4
 * Description: Contenido para el home bloque tipo 4
...
class HomeConten4 extends WP_Widget {

	// constructor
	function HomeConten4() {
	        parent::WP_Widget(false, $name = __('Home Conten block 4', 'wp_widget_plugin') );
...
// register widget
add_action('widgets_init', create_function('', 'return register_widget("HomeConten4");')); 
?>