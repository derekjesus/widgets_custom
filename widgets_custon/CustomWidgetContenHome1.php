 ...
 * 
 * Plugin Name: HomeConten1
 * Description: Contenido para el home bloque tipo 1
...
class HomeConten1 extends WP_Widget {

	// constructor
	function HomeConten1() {
	        parent::WP_Widget(false, $name = __('Home Conten block 1', 'wp_widget_plugin') );
...
?>  
  <p>
<?php /* WWWWWWWWWWWWWWWWWWWWWWWWWWWWWWWWWWWWWWWWWWWWWWWWWWWWWWWWWWWWWWWWWWWW Select de categorias WWWWWWWWWWWWWWWWWWWWWWWWWWWWWWWWWWWWWWWWWWWWWWWWWWWWWWWWWWWWWWWWWWWW  */ ?>
<label for="<?php echo $this->get_field_id('title'); ?>"><?php _e('Selecciona una categoría:', 'wp_widget_plugin'); ?></label>
<select class="widefat"  id="<?php echo $this->get_field_id('title'); ?>" name="<?php echo $this->get_field_name('title'); ?>">
 ...
 <?php /* WWWWWWWWWWWWWWWWWWWWWWWWWWWWWWWWWWWWWWWWWWWWWWWWWWWWWWWWWWWWWWWWWWWW FIN select de categorias WWWWWWWWWWWWWWWWWWWWWWWWWWWWWWWWWWWWWWWWWWWWWWWWWWWWWWWWWWWWWWWWWWWW  */ ?>
...
// register widget
add_action('widgets_init', create_function('', 'return register_widget("HomeConten1");')); 
?>